...
public class UsuarioPrincipal implements UserDetails {
	...
	public static UsuarioPrincipal build(UsuarioEntity usuario) {
		...
		List<GrantedAuthority> authorities = usuario.getRolAplicacionEntityCollection().stream()
				.map(rol -> new SimpleGrantedAuthority(rol.getNombre()))
				.collect(Collectors.toList());
		return new UsuarioPrincipal(usuario.getIdUsuario().longValue(), usuario.getNombres(), usuario.getNick(),
